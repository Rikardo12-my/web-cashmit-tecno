    ...
    <div class="container-fluid px-4">
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown mx-1">
                <!-- PERBAIKAN DI SINI: ganti data-toggle dengan data-bs-toggle -->
                <a class="nav-link d-flex align-items-center p-2" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">
